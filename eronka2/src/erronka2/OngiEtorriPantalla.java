...
public class OngiEtorriPantalla {
    ...
    private void initialize() {
        ...
        lblBienvenida.setBounds(200, 50, 400, 50);
        lblBackground.add(lblBienvenida);
    ...
    private void abrirPantallaNuevaAgencia() {
        ...
        pantallaNuevaAgencia.add(lblNombreAgencia);
        ...
        pantallaNuevaAgencia.add(txtNombreAgencia);
        ...
        pantallaNuevaAgencia.add(lblColorMarca);
        ...
        pantallaNuevaAgencia.add(txtColorMarca);
        ...
        pantallaNuevaAgencia.add(lblNumEmpleados);
        ...
        pantallaNuevaAgencia.add(cmbNumEmpleados);
        ...
        pantallaNuevaAgencia.add(lblTipoAgencia);
